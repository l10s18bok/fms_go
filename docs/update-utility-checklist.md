...
2. 🧪 **Phase 1-2 완료 전까지 프로그램 업데이트 기능 구현 금지**
...
2. 프로그램 관리 탭 신규 구현
3. 장비관리 탭 확장 (SSH 인증 정보, 프로그램 버전)
4. 배포 이력 탭 통합 (방화벽 룰 + 프로그램 업데이트)
5. 프로그램 업데이트 기능 구현 (SSH/SFTP + HTTP)

### 성공 기준
- [ ] 기존 방화벽 룰 배포 기능이 새 UI에서 정상 동작
- [ ] 프로그램 업데이트 기능 정상 동작 (SSH + SFTP + HTTP)
- [ ] 배포/업데이트 이력 통합 관리
...
- [ ] **방화벽 룰 관리 탭 기존 기능 정상 동작** ⭐
- [ ] **장비 관리 탭 기존 기능 정상 동작** ⭐
- [ ] **배포 이력 탭 기존 기능 정상 동작** ⭐

---

## Phase 2: 프로그램 관리 탭 구현
...
#### 2.3.3 프로그램 목록 테이블 (PagedTable 사용)
- [ ] 컬럼 정의
  - 선택 (체크박스)
  - 이름
  - 버전
...
**목표**: 장비관리 탭에 SSH 인증 정보, 프로그램 버전 추가
**상태**: ⏳ 대기
...
- [ ] 신규 필드 추가
  ...
  type Firewall struct {
      ...
      // 신규 필드 (프로그램 버전)
      Processes    []ProcessInfo `json:"processes"`     // 설치된 프로그램 목록
...
**목표**: 배포이력 탭을 방화벽 룰 + 프로그램 업데이트 통합 이력으로 변경
**상태**: ⏳ 대기
...
## Phase 5: 프로그램 업데이트 기능 구현

**목표**: SSH/SFTP 서비스 구현 및 프로그램 업데이트 연동
**상태**: ⏳ 대기
...
**기능 검증** (수동 테스트):
- [ ] 장비관리 탭에서 프로그램 업데이트 선택
- [ ] 프로그램 드롭다운에 등록된 프로그램 표시
- [ ] 장비 선택 후 업데이트 실행
- [ ] 업데이트 진행 상태 표시
- [ ] 업데이트 완료 결과 표시
...
#### 6.1.2 프로그램 업데이트 시나리오
- [ ] 프로그램 등록 → 장비 선택 → 업데이트 → 이력 확인
- [ ] 다중 장비 일괄 업데이트
...
| Phase 2: 프로그램 관리 탭 | ⏳ 대기 | 0% | 신규 탭 구현 |
| Phase 3: 장비관리 탭 확장 | ⏳ 대기 | 0% | SSH 인증 + 프로그램 버전 |
| Phase 4: 배포이력 탭 확장 | ⏳ 대기 | 0% | 통합 이력 |
| Phase 5: 프로그램 업데이트 | ⏳ 대기 | 0% | SSH/SFTP + HTTP |
